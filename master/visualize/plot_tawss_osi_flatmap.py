...
import os
from utils import tawss_utils as util
...
if __name__ == '__main__':
    ...
    file = "prediction_best_model_for_val_187epoch.pth_ch64_sheet_noise.h5_.h5"
    #file = "prediction_best_model_for_val_187epoch.pth_ch64_sheet.h5_.h5"
    #file = "prediction_best_model_for_val_187epoch.pth_ch64_clean.h5_.h5"
    hd5path = f"../examples/{file}"
    # hd5path = f"../examples/case70_prediction.h5"
    print(file)
    if not os.path.exists(hd5path):
        ...
        if save_img:
            plt.savefig(f'{img_dir}/tawss_osi_{file}_.png', dpi=200)
            plt.close()
        else:
